// utils/emailService.js - Updated to match your EmailJS template
import { supabase } from '../supabase';

// Gmail Configuration
const EMAIL_CONFIG = {
  FROM_EMAIL: 'jacal.io.service@gmail.com',
  FROM_NAME: 'Jacal Learning Platform',
  WEBSITE_NAME: 'Jacal',
  WEBSITE_URL: 'https://jacal.io',
  SUPPORT_EMAIL: 'jacal.io.service@gmail.com'
};

// Email templates with beautiful styling
...
class GmailEmailService {
  ...
  async sendEmail(to, template) {
    try {
      ...
      // Send email using EmailJS with the EXACT variable names from your template
      const response = await window.emailjs.send(
        ...
        this.emailJSTemplateId,
        {
          ...
          from_name: EMAIL_CONFIG.FROM_NAME, // {{from_name}}  
          from_email: EMAIL_CONFIG.FROM_EMAIL, // {{from_email}}
          subject: template.subject,        // {{subject}}
          html_content: template.html_content, // {{html_content}}
          reply_to: EMAIL_CONFIG.FROM_EMAIL  // {{reply_to}}
        }
      );
